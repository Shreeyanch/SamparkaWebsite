...
import styles from "./google-review-pop-up1.module.css";

export type GoogleReviewPopUp1Type = {
  onClose?: () => void;
};

const GoogleReviewPopUp1: NextPage<GoogleReviewPopUp1Type> = ({ onClose }) => {
...
export default GoogleReviewPopUp1;
